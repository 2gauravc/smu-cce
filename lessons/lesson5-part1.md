...
## Create a Simple Streamlit UI for Nimbus
...
Create a simple Streamlit web app for Nimbus.
...
Streamlit app
   ↓
Simple web UI for Nimbus
```

The notebook code becomes the application logic, and Streamlit provides the user interface.
